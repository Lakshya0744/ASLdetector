from convert_to_csv import listdir_nohidden
import cv2
import os
import random

# Path to the directory containing Video Files
path_to_video_files = "/Users/aryyamakumarjana/Downloads/ASLFingerspellingPrediction/Videos_Words/Demo_videos/"
...
video_files = listdir_nohidden(path_to_video_files)
print(video_files)
