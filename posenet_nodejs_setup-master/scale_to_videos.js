...
if (getArgumentValue === undefined) {
    photo_path_to_frames = "/Users/aryyamakumarjana/Downloads/ASLFingerspellingPrediction/posenet_nodejs_setup-master/Posenet_Frames";
} else {
    ...
    fs.readdir(photo_path, async function (err, items) {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            if (path.extname(items[i]) === "") {
                ...
                fs.writeFileSync(func_path + items[i] + ".mov.json", JSON.stringify(pose_list));
